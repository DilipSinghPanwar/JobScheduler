...
public class MainActivity extends Activity {
    ...
    public static final String MESSENGER_INTENT_KEY = "JOBSHEDULER.MESSENGER_INTENT_KEY";
    public static final String WORK_DURATION_KEY = "JOBSHEDULER.WORK_DURATION_KEY";
    ...
    public void finishJob(View v) {
        ...
        if (allPendingJobs.size() > 0) {
            ...
            Toast.makeText(MainActivity.this, String.format(getString(R.string.cancelled_job), jobId),Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(MainActivity.this, getString(R.string.no_jobs_to_cancel),Toast.LENGTH_SHORT).show();
        }
    }
